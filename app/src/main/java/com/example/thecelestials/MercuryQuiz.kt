...
class MercuryQuiz : AppCompatActivity() {
    ...
    private val correct = "MERCURY"
    private val incorrect = "EARTH"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mercury_quiz)

        choiceAImage = findViewById(R.id.choiceAImage)
        choiceBImage = findViewById(R.id.choiceBImage)
        mercuryQuizSpace = findViewById(R.id.mercuryQuizSpace)
        optionOne = findViewById(R.id.optionOne)
        optionTwo = findViewById(R.id.optionTwo)
        quizRight = findViewById(R.id.quizRight)
        quizWrong = findViewById(R.id.quizWrong)
        val mercuryQuiz = getString(R.string.mercury_quiz)
        ...
        fun firstAnim() {
            ...
            Handler().postDelayed({
                mercuryQuizSpace.visibility = View.VISIBLE
                animateTyping(mercuryQuizSpace, mercuryQuiz)
            }, 1000)
    ...
    private fun animateViewsOut() {
        ...
        animation.animateView(mercuryQuizSpace, Animation.AnimationType.FADE_OUT) {
            mercuryQuizSpace.visibility = View.INVISIBLE
        }
