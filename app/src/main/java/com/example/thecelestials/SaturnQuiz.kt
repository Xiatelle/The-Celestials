...
class SaturnQuiz : AppCompatActivity() {
    ...
    private val correct = "SATURN"
    private val incorrect = "JUPITER"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_saturn_quiz)

        choiceAImage = findViewById(R.id.choiceAImage)
        choiceBImage = findViewById(R.id.choiceBImage)
        saturnQuizSpace = findViewById(R.id.saturnQuizSpace)
        optionOne = findViewById(R.id.optionOne)
        optionTwo = findViewById(R.id.optionTwo)
        quizRight = findViewById(R.id.quizRight)
        quizWrong = findViewById(R.id.quizWrong)
        val saturnQuiz = getString(R.string.saturn_quiz)
        ...
        fun firstAnim() {
            ...
            Handler().postDelayed({
                saturnQuizSpace.visibility = View.VISIBLE
                animateTyping(saturnQuizSpace, saturnQuiz)
            }, 1000)
    ...
    private fun animateViewsOnCorrectAnswer() {
        ...
        Handler().postDelayed({
            val process = Intent(this, Uranus:: class.java)
    ...
    private fun animateViewsOut() {
        ...
        animation.animateView(saturnQuizSpace, Animation.AnimationType.FADE_OUT) {
            saturnQuizSpace.visibility = View.INVISIBLE
        }
