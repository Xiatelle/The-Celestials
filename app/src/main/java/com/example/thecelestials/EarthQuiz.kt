...
class EarthQuiz : AppCompatActivity() {
    ...
    private val correct = "THE GROUND"
    private val incorrect = "THE WORLD"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        earthQuizSpace = findViewById(R.id.earthQuizSpace)
        optionOne = findViewById(R.id.optionOne)
        optionTwo = findViewById(R.id.optionTwo)
        quizRight = findViewById(R.id.quizRight)
        quizWrong = findViewById(R.id.quizWrong)
        val earthQuiz = getString(R.string.earth_quiz)
        ...
        fun firstAnim() {
            ...
            Handler().postDelayed({
                earthQuizSpace.visibility = View.VISIBLE
                animateTyping(earthQuizSpace, earthQuiz)
            }, 1000)
    ...
    private fun animateViewsOut() {
        ...
        animation.animateView(earthQuizSpace, Animation.AnimationType.FADE_OUT) {
            earthQuizSpace.visibility = View.INVISIBLE
        }
