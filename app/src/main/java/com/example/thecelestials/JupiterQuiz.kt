...
class JupiterQuiz : AppCompatActivity() {
    ...
    private val correct = "JUPITER"
    private val incorrect = "SATURN"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_jupiter_quiz)

        choiceAImage = findViewById(R.id.choiceAImage)
        choiceBImage = findViewById(R.id.choiceBImage)
        jupiterQuizSpace = findViewById(R.id.jupiterQuizSpace)
        optionOne = findViewById(R.id.optionOne)
        optionTwo = findViewById(R.id.optionTwo)
        quizRight = findViewById(R.id.quizRight)
        quizWrong = findViewById(R.id.quizWrong)
        val jupiterQuiz = getString(R.string.jupiter_quiz)
        ...
        fun firstAnim() {
            ...
            Handler().postDelayed({
                jupiterQuizSpace.visibility = View.VISIBLE
                animateTyping(jupiterQuizSpace, jupiterQuiz)
            }, 1000)
    ...
    private fun animateViewsOnCorrectAnswer() {
        ...
        Handler().postDelayed({
            val process = Intent(this, Saturn:: class.java)
    ...
    private fun animateViewsOnIncorrectAnswer() {
        ...
        Handler().postDelayed({
            val process = Intent(this, Jupiter :: class.java)
            startActivity(process)
            overridePendingTransition(R.anim.fade_in, R.anim.fade_out)
        }, 2000)
    }
    ...
    private fun animateViewsOut() {
        ...
        animation.animateView(jupiterQuizSpace, Animation.AnimationType.FADE_OUT) {
            jupiterQuizSpace.visibility = View.INVISIBLE
        }
