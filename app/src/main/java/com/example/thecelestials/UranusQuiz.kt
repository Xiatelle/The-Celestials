...
class UranusQuiz : AppCompatActivity() {
    ...
    private val correct = "SEVENTH"
    private val incorrect = "SIXTH"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_uranus_quiz)

        choiceAImage = findViewById(R.id.choiceAImage)
        choiceBImage = findViewById(R.id.choiceBImage)
        uranusQuizSpace = findViewById(R.id.uranusQuizSpace)
        optionOne = findViewById(R.id.optionOne)
        optionTwo = findViewById(R.id.optionTwo)
        quizRight = findViewById(R.id.quizRight)
        quizWrong = findViewById(R.id.quizWrong)
        val uranusQuiz = getString(R.string.uranus_quiz)
        ...
        fun firstAnim() {
            ...
            Handler().postDelayed({
                uranusQuizSpace.visibility = View.VISIBLE
                animateTyping(uranusQuizSpace, uranusQuiz)
            }, 1000)
    ...
    private fun animateViewsOut() {
        ...
        animation.animateView(uranusQuizSpace, Animation.AnimationType.FADE_OUT) {
            uranusQuizSpace.visibility = View.INVISIBLE
        }
